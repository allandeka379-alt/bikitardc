...
export const PAYMENT_METHODS: PaymentMethod[] = [
  { channel: 'ecocash',    label: 'EcoCash',            tagline: 'Pay from your EcoCash wallet.',          tint: 'red',   demoStatus: 'full',   needsPhone: true },
  { channel: 'onemoney',   label: 'OneMoney',           tagline: 'Pay from your OneMoney wallet.',         tint: 'green', demoStatus: 'full',   needsPhone: true },
  { channel: 'innbucks',   label: 'InnBucks',           tagline: 'Pay from your InnBucks wallet.',         tint: 'gold',  demoStatus: 'full',   needsPhone: true },
  { channel: 'paynow',     label: 'Paynow',             tagline: 'Card or ZIPIT via Paynow checkout.',     tint: 'navy',  demoStatus: 'full',   needsPhone: false },
  { channel: 'zimswitch',  label: 'ZimSwitch card',     tagline: 'Tap-and-go ZimSwitch debit card.',       tint: 'blue',  demoStatus: 'visual', needsPhone: false },
  ...
  { channel: 'mastercard', label: 'Visa / Mastercard',  tagline: 'Pay from a diaspora card. FX preview before charge.', tint: 'navy',  demoStatus: 'visual', needsPhone: false, isDiaspora: true, sourceCurrency: 'GBP' },
